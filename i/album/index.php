  ...
  <section class="py-5 text-center container">
    <div class="row py-lg-5">
      <div class="col-lg-6 col-md-8 mx-auto">
        <h1 class="fw-light">อุปกรณ์การเรียน</h1>
        <p class="lead text-body-secondary">เด็กดี</p>
        <p>&nbsp;</p>
        
      </div>
    </div>
    <form method="post" action="">
    <input type="text" name="kw" class="form-control" autofocus>
    <input type="submit" name="Submit" value="ค้นหา" class="btn btn-success my-2">
</form>
  </section>
...
?>
        ...
        <div class="col">
          <div class="card shadow-sm">
            ...
            <div class="card-body">
               <b><?=$data['p_name'];?></b></br></p>
              <p class="card-text"><strong>ราคา <?=$data['p_price'];?> บาท</strong><br> 
			 
              <div class="d-flex justify-content-between align-items-center">
                <div class="btn-group">
                  <button type="button" class="btn btn-sm btn-outline-success" 
                  onClick="window.location='detail.php?id=<?=$data['p_id'];?>';">รายละเอียด </button>
                  <button type="button" class="btn btn-sm btn-info">หยิบใส่ตะกร้า</button>
                </div>
